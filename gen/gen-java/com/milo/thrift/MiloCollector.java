              ...
              if (field.type == TType.LIST) {
                {
                  ...
                  this.messages = new ArrayList<LogEntry>(_list14.size);
                  for (int _i15 = 0; _i15 < _list14.size; ++_i15)
                  {
                    LogEntry _elem16;
                    _elem16 = new LogEntry();
                    _elem16.read(iprot);
                    this.messages.add(_elem16);
                  }
                  iprot.readListEnd();
                }
              } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.messages != null) {
        oprot.writeFieldBegin(MESSAGES_FIELD_DESC);
        {
          ...
          for (LogEntry _iter17 : this.messages)
          {
            _iter17.write(oprot);
          }
          oprot.writeListEnd();
